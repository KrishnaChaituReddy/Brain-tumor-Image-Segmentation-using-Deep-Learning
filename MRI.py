...
main = tkinter.Tk()
main.title("Brain tumor Image segmentation using deep learning") #designing main screen
...
def predict():
    ...
    ftp.login("chaitanyareddy3399","India123")
    ftp.prot_p()
    name = imagelist.get()
...
font = ('times', 16, 'bold')
title = Label(main, text='Brain tumor Image segmentation using deep learning')
